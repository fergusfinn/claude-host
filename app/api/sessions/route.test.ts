...
describe("POST /api/sessions", () => {
  it("creates a session and returns 201", async () => {
    ...
    expect(mockCreate).toHaveBeenCalledWith("test", "bash", undefined, undefined, "local", undefined, undefined);
  });
  ...
  it("creates a session with no description", async () => {
    ...
    expect(res.status).toBe(201);
    expect(mockCreate).toHaveBeenCalledWith(undefined, undefined, undefined, undefined, "local", undefined, undefined);
  });
